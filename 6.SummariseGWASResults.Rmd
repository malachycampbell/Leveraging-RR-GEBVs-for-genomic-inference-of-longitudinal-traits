...
length(unique(RR.array))
length(unique(TP.array))
```
...
TP.beta <- as.matrix( read.csv("/Users/malachycampbell/Desktop/RRgwas_git/CompCluster/TP/Eff.mat.csv") )
RR.beta <- as.matrix( read.csv("/Users/malachycampbell/Desktop/RRgwas_git/CompCluster/RR/Eff.mat.csv") )
...
min(RR.beta[RR.beta$Var1 %in% Sig.RR ,]$value) #-309.6
max(RR.beta[RR.beta$Var1 %in% Sig.RR ,]$value) #366.3

min(TP.beta[TP.beta$Var1 %in% Sig.TP ,]$value) #-106.0
max(TP.beta[TP.beta$Var1 %in% Sig.TP ,]$value) #114.3

Sig.TP <- TP.p[TP.p$value < 1E-4 ,]$Key
Sig.RR <- RR.p[RR.p$value < 1E-4 ,]$Key
```

## Plot SNP effects for RR and TP approaches
This code was used to create figure 1.
```{r code for figure 1}
#pdf("/Users/malachycampbell/Desktop/RRgwas_git/Figures/Fig1.pdf", h=6, w=3.25, useDingbats = F, pointsize = 10)
...
```{r manhattan plot function, echo = T}
...
for (i in 1:20){
  if(i < 10){
    #pdf("/Users/malachycampbell/Desktop/RRgwas_git/Figures/FigS1.pdf", h=10, w=7, useDingbats = F, pointsize = 10)
    ...
    #pdf("/Users/malachycampbell/Desktop/RRgwas_git/Figures/FigS2.pdf", h=10, w=7, useDingbats = F, pointsize = 10)
    par(mar=c(3,3,2,1), mgp=c(1.8,0.5,0))
    nf = layout(rbind(c(1,2), c(3,4), c(5,6), c(7,8), c(9,10)))
...
for (i in 1:20){
  if(i < 10){
    #pdf("/Users/malachycampbell/Desktop/RRgwas_git/Figures/FigS3.pdf", h=10, w=7, useDingbats = F, pointsize = 10)
    par(mar=c(3,3,2,1), mgp=c(1.8,0.5,0))
    nf = layout(rbind(c(1,2), c(3,4), c(5,6), c(7,8), c(9,10)))
    ...
    #pdf("/Users/malachycampbell/Desktop/RRgwas_git/Figures/FigS4.pdf", h=10, w=7, useDingbats = F, pointsize = 10)
    par(mar=c(3,3,2,1), mgp=c(1.8,0.5,0))
    nf = layout(rbind(c(1,2), c(3,4), c(5,6), c(7,8), c(9,10)))
...
#pdf("/Users/malachycampbell/Desktop/RRgwas_git/Figures/Fig2.pdf", h=4, w=7, useDingbats = F, pointsize = 10)
par(mar=c(3,3,2,1), mgp=c(1.8,0.5,0))
